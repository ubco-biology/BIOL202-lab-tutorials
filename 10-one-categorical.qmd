...
```{r fig.cap = "Observed frequency of each hair colour among a sample of 100 students. The dashed line shows the frequency expected under the null hypothesis of equal proportions (25 students per category).", fig.height = 4, fig.width = 5}
...
> The four hair colours did not occur in equal proportion among the sampled students ($\chi$^2^ goodness-of-fit test; *df* = `r hair.chisq.results$parameter`; $\chi$^2^ = `r round(hair.chisq.results$statistic, 2)`; *P* < 0.001). Based on our bar graph (Fig. X), Black and Brown hair occurred more frequently than expected under equal proportions, while Blonde and Red hair occurred less frequently than expected.
