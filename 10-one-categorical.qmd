...
Load the `damselfly` dataset we used in the preceding [tutorial](09-hypothesis-testing.qmd#hypothesis), and also the `birds` dataset we used in an earlier [tutorial](06-describe-one-variable.qmd#vis_describe).
