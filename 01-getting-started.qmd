...
If you've read the error, checked the troubleshooting page, and searched it, and you're still stuck, post your question on Piazza. Include the exact error message and a copy of the code that produced it — that's exactly what you'd have searched for in Step 3, so you already have it ready to go. Chances are good a classmate has hit the same wall and can help, or the instructor/TA will.
...
You may notice RStudio has a built-in "Posit Assistant" button offering to help with exactly this kind of problem. **Don't rely on it** — it requires a paid subscription to use, and this course is designed so that nothing you need costs money. The free tools described here (the troubleshooting page, Google, and the free tiers of tools like Claude or ChatGPT) are all you need.

Used well, an AI chatbot can:
...
Used poorly, it becomes a shortcut that skips the learning:
