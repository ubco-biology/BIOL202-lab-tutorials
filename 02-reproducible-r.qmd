...
```{r down_rmd, eval = F}
download.file("https://raw.githubusercontent.com/ubco-biology/BIOL202/main/images/Example_tutorial_markdown.Rmd", "BIOL202_tutorial_markdown.Rmd")
```
...
1. **R Markdown basics**: Read through section 4.2 of this online [tutorial](https://rbasics.netlify.app/4-rmarkdown.html#the-components-of-an-r-markdown-file) and watch the videos there too
