...
The `marine` dataset is discussed in example 13.1 in the text book.  The `flowers` dataset is described below. The `students` dataset includes data about BIOL202 students from a few years ago.
...
```{r fig-14-example-normal-quantile-plot, echo = F, fig.width = 5, fig.height = 4, fig.cap = "Example of a normal quantile plot for a variable that is normally distributed."}
...
```{r fig-14-frequency-distribution-biomass-ratio, echo = TRUE, fig.cap = "The frequency distribution of the 'biomass ratio' of 32 marine reserves.", fig.width = 4, fig.height = 3}
...
```{r fig-14-normal-quantile-plot-biomass, fig.cap = "Normal quantile plot of the 'biomass ratio' of 32 marine reserves.", fig.width = 4, fig.height = 3}
marine %>% 
...
```{r fig-14-frequency-distribution-biomass-ratio-2, echo = TRUE, fig.cap = "The frequency distribution of the 'biomass ratio' of 32 marine reserves.", fig.width = 4, fig.height = 3}
...
```{r fig-14-frequency-distribution-biomass-ratio-3, echo = TRUE, fig.cap = "The frequency distribution of the 'biomass ratio' of 32 marine reserves (log-transformed).", fig.width = 5, fig.height = 4}
...
```{r fig-14-normal-quantile-plot-biomass-2, fig.cap = "Normal quantile plot of the 'biomass ratio' of 32 marine reserves (log-transformed).", fig.width = 4, fig.height = 3}
...
```{r fig-14-normal-quantile-plot-made, echo = F, fig.width = 5, fig.height = 4, fig.cap = "Normal quantile plot of made-up biomass data."}
...
```{r fig-14-normal-quantile-plot-made-2, echo = F, fig.width = 5, fig.height = 4, fig.cap = "Normal quantile plot of made-up biomass data, log-transformed."}
...
```{r fig-14-normal-quantile-plot-proportion, fig.cap = "Normal quantile plot of the proportion of seeds fertilized on 30 plants (left) and the corresponding normal quantile plot (right)", fig.width = 4, fig.height = 3}
...
```{r fig-14-normal-quantile-plot-proportion-2, fig.cap = "Normal quantile plot of the proportion of seeds fertilized (logit transformed) on 30 plants", fig.width = 5, fig.height = 4}
