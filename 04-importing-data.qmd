...
students <- read_csv("https://raw.githubusercontent.com/ubco-biology/BIOL202-lab-tutorials/main/data/students.csv")
```
...
::: {.callout-note}
The CSV copies of the course datasets are all stored at the same URL location, specifically: "https://raw.githubusercontent.com/ubco-biology/BIOL202-lab-tutorials/main/data/". (**note** that clicking on this URL will not load a website). To import any of them, copy that path and append the file name. For example, the full path to the `birds.csv` file would be "https://raw.githubusercontent.com/ubco-biology/BIOL202-lab-tutorials/main/data/birds.csv".
